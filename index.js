...
3. "${ENDORSER_NAME_3}, as a person who looks up to ${INTERVIEWEE_NAME} both literally and figuratively, what do you admire most about ${INTERVIEWEE_NAME} and what are the odds that he will become a Jedi? (respond with 'Never tell me the odds!')."
`;
